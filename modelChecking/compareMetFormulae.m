function [yn,element,metEle] = compareMetFormulae(metFormulas_1, metFormulas_2)
...
[metEle1, ele1] = getElementalComposition(metFormulas_1, [], 1);
[metEle2, ele2] = getElementalComposition(metFormulas_2, [], 1);
